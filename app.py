...
# 1. CONFIG & API SETUP
# -----------------------------------
# This connects the code to your Secret Key in Streamlit's settings
...
# -----------------------------------
def speak(text):
    """Converts text to speech and plays automatically."""
...
def detect_fillers(text):
    """Counts common interview filler words."""
...
def generate_pdf(score_text, filler_count, feedback):
    ...
    data = [
        ...
        ["Filler Words Used", str(filler_count)]
    ]
    ...
    elements.append(Paragraph("Detailed AI Evaluation:", styles["Heading2"]))
...
st.caption("Voice-based interview training with smart filler detection")
...
if st.button("▶ Start Interview") and resume_text:
    with st.spinner("AI is generating a question..."):
        ...
        st.session_state.transcript = None # Clear previous
...
if st.session_state.question:
    ...
    audio_data = audio_recorder(text="Click to start speaking", pause_threshold=2.5)
            ...
            with tempfile.NamedTemporaryFile(delete=False, suffix=".wav") as f:
                ...
                with sr.AudioFile(f.name) as source:
                    ...
                    try:
                        ...
                        st.error("Audio unclear. Please try speaking again.")
...
if st.session_state.transcript and st.button("🛑 Stop & Evaluate"):
    with st.spinner("Analyzing performance..."):
        ...
        Provide a score out of 10, explain why, and give an ideal version of the answer.
        """
        ...
        # PDF Download
        pdf_path = generate_pdf("Calculated by AI", total_fillers, st.session_state.result)
